 ...
 */
package external.nutch.scoring.initial;
...
public class InitialStaticScoringFilter implements ScoringFilter {

  private Configuration conf;
  private float initialScore = 1.00f;
  ...
  public InitialStaticScoringFilter() {
  }
